package ro.codecamp.ebp.features.manufacturer;
...
@Component
public class ManufacturerFeature implements RegistryAwareFeature
{
    ...
    public FeatureInfo getFeatureInfo() 
    {
        ...
        info.setFriendlyName("Manufacturer Feature");
